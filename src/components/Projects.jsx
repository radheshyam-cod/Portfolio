              ...
              >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem', transformStyle: 'preserve-3d' }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px', transform: 'translateZ(10px)' }}>
                    {project.github && (
                      <a href={project.github} target="_blank" rel="noopener noreferrer" aria-label={`View ${project.title} on GitHub`} style={{ color: 'var(--color-text-muted)', transition: 'color 0.2s' }} onClick={(e) => e.stopPropagation()}>
                        <Github size={18} />
                      </a>
                    )}
                    {project.live && (
                      <a href={project.live} target="_blank" rel="noopener noreferrer" aria-label={`View ${project.title} live`} style={{ color: 'var(--color-text-muted)', transition: 'color 0.2s' }} onClick={(e) => e.stopPropagation()}>
